...
public class ExprRewriteRulesTest extends BaseRewriteRulesTest {
  ...
  public void TestFoldConstantsRule() throws ImpalaException {
    ...
    // Null handling. Verifies the case that a NULL
    // is represented by CAST(NULL as <type>).
    RewritesOk("null + 1", rule, "NULL");
    RewritesOk("cast(null as INT) IS NULL", rule, "TRUE");
    RewritesOk("(null + 1) is null", rule, "TRUE");
    RewritesOk("(1 + 1) is null", rule, "FALSE");
  }

  @Test
  public void adHocTest() throws ImpalaException {
    RewritesOk("cast(null as INT) IS NULL", FoldConstantsRule.INSTANCE, "TRUE");
  }
