...
public class FrontendFixture {
  ...
  public AnalysisResult parseAndAnalyze(String stmt, AnalysisContext ctx)
    ...
    return ctx.analyzeAndAuthorize(parsedStmt, stmtTableCache, frontend_.getAuthzChecker());
  }
   ...
   */
  public ParseNode analyzeStmt(String stmt, AnalysisContext ctx, String expectedWarning) {
    try {
